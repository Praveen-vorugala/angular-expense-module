const _apiDirectory = {
    ...
    "createPolicy":"/api/policies/policies/create-policy/",
    "getPolicies":"/api/policies/policies/",
    ...
    "expenseApprovalReports":"/api/expenses/expense-approvals/",
    ...
    "getPlaces":"/api/auth/places/",
    "approveExpenses":"/api/expenses/expense-approvals/",
    "uploadSampleFile":"/api/upload/",
