...
@Component({
      ...
      <mat-sidenav #sidenav [mode]="'side'" [opened]="true" [fixedInViewport]="true" 
        ...
        <mat-nav-list class="py-2">
          ...
          <a mat-list-item routerLink="/dashboard" routerLinkActive="active" 
            class="hover:bg-gray-50" [ngClass]="isCollapsed? 'menu-collapsed':''" (click)="closeSidenav()">
          ...
          <a mat-list-item routerLink="/submit-expense" routerLinkActive="active" 
             class="hover:bg-gray-50" [ngClass]="isCollapsed? 'menu-collapsed':''" *ngIf="isEmployee || isManager " (click)="closeSidenav()">
          ...
          <a mat-list-item routerLink="/reports" routerLinkActive="active" 
             class="hover:bg-gray-50" [ngClass]="isCollapsed? 'menu-collapsed':''" *ngIf="isEmployee ||isManager " (click)="closeSidenav()">
            <mat-icon class="text-gray-500 menu-collapsed">check_circle</mat-icon>
          ...
          <a mat-list-item routerLink="/expense-report-approval" routerLinkActive="active" 
             class="hover:bg-gray-50" [ngClass]="isCollapsed? 'menu-collapsed':''" *ngIf="isAdmin ||isManager " (click)="closeSidenav()">
          ...
          <a mat-list-item routerLink="/policies" routerLinkActive="active" 
             class="hover:bg-gray-50" [ngClass]="isCollapsed? 'menu-collapsed':''" *ngIf="isAdmin" (click)="closeSidenav()">
  ...
  styles: [`
    ...
    :host ::ng-deep .menu-collapsed .mat-mdc-list-item-unscoped-content{
